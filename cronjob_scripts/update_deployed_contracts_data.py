...
def update_contract_info_cron(contract_addr):
    ...
    if refounded == True or refounded == 'true' or refounded == 'True':
        ...
        session.commit()
        #remove the cronjob
        command_to_delete = f'/home/andrea/anaconda3/envs/vyper/bin/python /home/andrea/Desktop/paywac_website_v02/cronjob_scripts/cron_update_info_paywac.py {contract_addr} > /home/andrea/Desktop/paywac_website_v02/logs/cron.log 2>&1'
